<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="RoomToRead.ContactUs" %>
...
.other{
	width: 60%;
	background-image: url("img\\con12.png");
...
.other:before{
	...
	height: 100%;
	width: 100%;
	background: linear-gradient(rgb(234 239 243), rgb(40 82 31 / 81%));
}
...
<form runat="server"  action="https://formspree.io/f/xjvdkveg" method="POST" >
	...
	<div class="contact">
		...
		<div class="form">
			<h1>Get In Touch</h1>
				...
				<div class="flex-rev">
					<asp:TextBox  placeholder="Connor Gaunt" name="name" id="name"  runat="server"></asp:TextBox>
				
					<label for="name">Full Name</label>
				</div>
				<div class="flex-rev">
					<input type="email" placeholder="connor@connorgaunt.com" runat="server" name="email" id="email" />
					<label for="email">Your Email</label>
				</div>
			<div class="flex-rev">
					<input runat="server"  placeholder="My thread is talking about...." name="Subject" id="subject"/>
					<label for="subject">Subject</label>
				</div>

				<div class="flex-rev">
					<textarea placeholder="I have an idea for a project...." runat="server" name="message" id="message"></textarea>
					<label for="message">Email Message</label>
				</div>
			<input id="Submit1" type="submit" class="Button" value="submit" Style="background: linear-gradient(rgb(234 239 243), rgb(40 82 31 / 81%)); border:none;width:35%; height:30px !important; color:white;border-radius:10px;" />
