<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="RoomToRead.test" %>
...
<head runat="server">
    ...
    <script src="Adminjs/bootstrap.min"></script>
    <script src="Adminjs/jquery-3.3.1.min"></script>
    <script src="Adminjs/main"></script>
    <script src="Adminjs/owl.carousel.min"></script>
    <script src="Adminjs/popper.minl"></script>
</head>
<body>
